...
import day45_Interface.Animal_Task.Cat;
import day45_Interface.Animal_Task.Dog;
import day45_Interface.Animal_Task.Playable;
import day45_Interface.Shape.*;
...
public class Polymorphisim {
    ...
    public static void main(String[] args) {
        ...
        Animal animal = new Dog("Max", "Husky", "PINK","SMALL",'m',4);
        animal.drink();
        animal.eat();
        // animal.play();
        //  animal.bark();
        ...
        Playable animal2 = new Dog("Max", "Husky", "PINK","SMALL",'m',4);
