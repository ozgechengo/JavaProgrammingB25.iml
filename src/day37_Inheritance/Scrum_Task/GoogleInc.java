...
public class GoogleInc {
   public static void main(String[] args) {
            ...
            ProductOwner po = new ProductOwner("Suhaib", 29, 'M',"PO", 2323,1121221,"Amazon");

            BusinessAnalyst ba = new BusinessAnalyst("Cihad", 30, 'M', "BA", 1500,232323,"Amazon");

            ScrumMaster sm = new ScrumMaster("Anel", 26, 'F', "SM", 145000, 212123,"amazon");
